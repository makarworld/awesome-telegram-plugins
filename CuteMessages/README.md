...
Перед отправкой меняет текст сообщения: добавляет cute-эффекты, сохраняя **жирный**, *курсив*, `код` и другое форматирование.
...
4. **Откат:** долгий тап на своё сообщение → «Вернуть оригинал» (последние 5).
