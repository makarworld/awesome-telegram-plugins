...
> 🏷️ Версия **3.1.4** · @Th3Nek1t_projects
...
Если основной файл не ставится или плагин не запускается — используй сборку с пониженным `__app_version__` (код v3.0.5, проверено на старых клиентах):
...
2. Режим провайдера: **auto** (рекомендуется) или выбери вручную переключателем.
...
4. **LeanVPN Premium** (Швейцария): нужна подписка **LTE** или **Ultimate** в [@VPN_Lean_bot](https://t.me/VPN_Lean_bot). Плагин проверит доступ по всем подключённым аккаунтам — переключатель появится после подтверждения.

## Настройки

- Вкл/выкл туннель
- Провайдер: auto / Nimarko / Th3Nekit / LeanVPN Premium (переключатели)
...
- Трафик идёт через **сторонние серверы** (`r1.nimarko.org`, `ws.th3web.com`, `wszh.th3web.com`). Это не VPN.
...
🟠 **Осторожно** (Pluggy v3.1.4) · [secure.md](secure.md) · Changelog: [v3.1.4](releases/v3.1.4/CHANGELOG.md) · [v3.1.2](releases/v3.1.2/CHANGELOG.md)
